...
*/
	...
	Majestic.applet('curve', {
		...
		init : function() {
			...
			if (Majestic(this.elements)[0].tagName.toUpperCase() != 'CANVAS') {
				
				this.canvas = Majestic(this.elements).put('<canvas />');
				
				this.canvas.css({
					'width': Majestic(this.elements).width(),
					'height': Majestic(this.elements).height()
				}).attr({
					'width': Majestic(this.elements).width(),
					'height': Majestic(this.elements).height()
				})
				...
				this.canvas = Majestic(this.elements)[0];
			};				
